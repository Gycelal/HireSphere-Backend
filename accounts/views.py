...
from .utils import get_stored_otp, delete_stored_otp, generate_otp, store_otp, get_otp_resend_count
...
class ResendOTPView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if count >= 3:
            return Response({"error": "You have exceeded the maximum number of OTP resend attempts. Please try again later."}, status=status.HTTP_429_TOO_MANY_REQUESTS)
